...
class MainApp(pitalk.PiTalk, tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.w = 800  #screen width
        self.h = 480  #screen height
        ...
        self.networkLabel = tk.Label(self.Topframe, text ="",font=("bold", 14), bg = "black", fg = "OliveDrab1")
        self.networkLabel.grid(row = 0, column = 0, columnspan = 3 , sticky = "w")
        
        self.timeLabelTop = tk.Label(self.Topframe, text = "",font=("bold", 14),bg = "black", fg = "tomato")
        self.timeLabelTop.grid(row = 0, column = 3,padx=(0,110), columnspan = 3)
        ...
        self.signal = tk.Canvas(self.Topframe, width=self.bar_width, height=self.bar_height, bg= "black",highlightthickness=0, bd=0)
...
class HomeFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.canvas = tk.Canvas(self,bg="black",width = 800, height = 240,
                                highlightthickness=0,bd=0)
        self.circle = self.canvas.create_rectangle(250,25,520,230,
        ...
        self.dateLabel = tk.Text(self,bg = "black", fg = "yellow" ,
                                 height = 8, width = 25, bd  = 0,
                                 highlightthickness = 0, font = 20)
    ...
    def __init__(self, parent, controller):
        ...
        for b in range(len(BUTTON)):
            ...
            tk.Button(self, text = BUTTON[b][0],bg = "white", fg = "black",
                      font = ("Helvetica", 15), bd = 0,highlightbackground="white",
                      activebackground = "white", activeforeground = "black",
                      image = BUTTON[b][1],compound = 'top',
                      command = cmd).grid(row = BUTTON[b][3],
                                          column = BUTTON[b][4],ipadx = 0,
                                          ipady = 0) 
...
class CallFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.diallednumber = tk.Entry(self, font = ('bold', 22), width = 30,
    ...
    def outgoing_Call(self):
        ...
        if len(self.diallednumber.get()):
            ...
            self.speaker = tk.Button(self, image = icons[34],bd=0,
                                     bg = "white", fg = "black",
                                     highlightbackground = "white",
                                     activebackground = "white",
                                     activeforeground = "white",
            ...
            self.controller.call_log(path + '/Logs/Call/Outgoing.txt',
                                     self.number)

            self.label = tk.Label(self, text = "", fg = "white", bg = "white",
                                  font=("helvetica", 14))
            self.label.place(x = 340, y = 350)
...
class CallIncomingFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.incominglabel = tk.Label(self, text = "Incoming Call",
                                      fg = "gold3", bg = "black",
                                      font = ("bold",20))
        ...
        self.label.place(x = 330, y = 320)

        self.hangup = tk.Button(self, image = icons[6],bg = "black",
                                fg = "black", bd = 0,
                                highlightbackground = "black",
                                activebackground = "black",
                                command = self.call_hangup)
    ...
    def call_connect(self):
        ...
        self.controller.call_log(path + '/Logs/Call/Incoming.txt',
                                 phone.callerID)

    def call_time_counter(self):
        """ Call time counter """
        if(self.Fl_incoming_call_start):
            self.timer.configure(text = "%02d:%02d:%02d" %(self.hour,
                                                           self.minute,
                                                           self.second))
...
class MessageFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        BUTTON = [# Text            Image       Frame          Row Col
                  ...
                  ("Sent Message", icons[25],  "MessageFrame",  2, 0),
        ...
        home = tk.Button(self, bg = "white", fg = "white", bd = 0,
                         image = icons[16],highlightbackground = "white",
                         activebackground = "white",activeforeground = "black",
...
class InboxFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas.create_window((0,0), window = self.frame, width = 800,
                             anchor = "nw")
...
class InboxBodyFrame(tk.Frame):
    ...
    def open_sms(self, args):
        ...
        self.numberSMS = tk.Label(self,
                                  text = self.controller.messageData[args][0],
                                  bg = "black", fg= "DarkGoldenrod3",
                                  font = ("bold",18))
        self.numberSMS.grid(row = 0, column = 0,columnspan = 3,sticky = "nsew")

        self.datetime = tk.Label(self,
                                 text = self.controller.messageData[args][1],
        ...
        self.bodySMS.grid(row = 2, column = 0, columnspan = 3,padx=40,
                          sticky = "nsew")
        ...
        self.reply = tk.Button(self,text = "Reply",font= ("bold", 15),
                               ...
                               activeforeground="black",
                               activebackground="white",
                               command = lambda args=args:
                               self.reply_msg(args))
        self.reply.grid(row = 3, column = 1)

        self.back = tk.Button(self, bg = "black",bd = 0,
                              highlightbackground="black",
                              activeforeground = "black",
                              activebackground = "black",
...
class CreateSMSFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.messageBody = tk.Text(self, font = ('bold', 16), height = 8,
                                   width = 35)
        ...
        for k in range(30):
            ...
            self.buttonCharData[k] = tk.Button(self,font = ('Helvetica', 15),
                                               text = self.specialChar[k],
                                               command = lambda k=k:
                                               self.messageEntry
                                               (self.specialChar[k]))
            self.buttonCapsData[k] = tk.Button(self, font = ('Helvetica', 15),
                                               text = self.letterCaps[k],
                                               command = lambda k=k:
                                               self.messageEntry
                                               (self.letterCaps[k]))
            self.buttonData[k] = tk.Button(self, font = ('Helvetica', 15),
                                           text = self.letter[k],
                                           command = lambda k=k:
        ...
        home = tk.Button(self, text = "HOME",font = ('Helvetica', 14),
                         fg = "Deep Sky Blue", command = lambda:
                         controller.show_frame("HomeFrame"))
        home.grid(row = 5, column = 0, columnspan = 2 , sticky = "nsew")
        
        capital_char = tk.Button(self, text = "UP",font = ('Helvetica', 14),
                                 command = self.capitalLetters)
        capital_char.grid(row = 5, column = 2 ,sticky = "nsew")

        space = tk.Button(self, text = "space",font = ('Helvetica', 14),
                          bg = "gray60",command = lambda:self.messageEntry(" "))
        space.grid(row = 5, column = 3, columnspan = 4, sticky = "nsew")

        symbols = tk.Button(self, text = "SYM",font = ('Helvetica', 14),
                            command = self.specialCharacters)
        symbols.grid(row = 5, column = 7,sticky = "nsew")

        delete = tk.Button(self, text = "DEL",font = ('Helvetica',14),fg="red4",
...
class DeleteSMSFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel = tk.Label(self, bg = "black",
                                     fg = "Deep sky blue",
                                     text = "Selecting this deletes messages "
                                     "from your GSM Module only",
                                     font = ("Helvetica", 20))
...
class CamFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Button(self,text="Video", bg = "black", fg = "white", bd = 0,
                  font=("Helvetica",16), highlightbackground = "black",
                  activebackground = "black",activeforeground = "white",
                  image = icons[10], compound="top",
                  command = lambda:
                  self.startPreview("Video")).place(x = 450, y = 100)
    ...
    def startPreview(self, arg):
        ...
        self.cameraMode = arg
        label = tk.Label(self, text="",font=("helvetica", 15), bg='black')
...
class InternetFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.APN.grid(row = 0, column = 2, columnspan = 6,sticky = "nsew",
                      pady = 20)
        ...
        self.Port.grid(row = 1, column = 2, columnspan = 6,sticky = "nsew",
                       pady = 20)
        ...
        self.connect.grid(row = 0, column = 8, columnspan = 2, sticky = "nsew",
                          padx = 20)
    ...
    def connect(self):
        ...
        if (len(self.APN.get()) and len(self.Port.get())):
            subprocess.call(shlex.split('sudo ' + path+'/PPP/ppp_create.sh '+
                                        str(self.APN.get())+" "+
                                        str(self.Port.get())))
            ...
            label = tk.Label(self, font=("helvetica", 14),
                             text = "Enter values", bg = "yellow", fg = "black")
    ...
    def check_status(self):
        ...
        if "ppp0" in str(subprocess.check_output(["ifconfig"])):
            label = tk.Label(self, font=("helvetica", 14), text = "Connected",
                             bg = "OliveDrab", fg = "white")
            label.grid(row = 2, column = 0, columnspan = 2)
            label.after(2000, label.grid_forget)

        else:
            label = tk.Label(self, font=("helvetica", 14),
                             text = "Not Connected", bg = "red", fg = "black")
...
class GalleryFrame(tk.Frame):
    """ This class handle Gallery """                                                                  #are the names of videos and photos aligning with the sorted keyword to give
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)                                                         #the latest pic/video on top??
        tk.Frame.config(self, bg="white")
        self.controller = controller
        self.images = []
        self.index = 0
        ...
        self.home.place(x=380,y=400)

        self.prev = tk.Button(self, text = "<<", bg = "white", fg = "black",
                              font = ("Helvetica", 18), bd = 0,
                              highlightbackground = "white",
                              activebackground="white",activeforeground="black",
                              state = "disable", command = self.prev_image)
        self.prev.place(x=230, y=410)
        ...
        self.next.place(x=520, y=410)

        self.label = tk.Label(self,text = "", font=("bold", 15),bg="white",
                              fg="black")
        self.label.place(x=700, y=420)
    ...
    def view_video(self):
        ...
        if os.listdir('Gallery/Videos'):
            ...
            self.canvas.create_window((0,0), window = self.frame, width = 800,
                                      anchor = "nw")
            ...
            self.frame.grid_columnconfigure(0, weight = 1)
            self.videohome = tk.Button(self.frame, bg = "white", fg = "white",
...
class StopwatchFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.canvas = tk.Canvas(self,bg="black",width = 240, height = 200,
                                     highlightthickness=0,bd=0)
        self.canvas.create_rectangle(305,100,500,200,outline="royal blue",
                                     width=7)
        self.canvas.grid(row = 0, column = 0, rowspan = 3,columnspan = 3,
                         sticky = "nsew")

        tk.Label(self, text = "HH : MM : SS", font = ('bold', 18),
                 fg = "white", bg = "black").place(x = 320, y = 65)
        ...
        self.startwatch.grid(row = 3, column = 0)#, sticky = "nsew")
        ...
        self.stopWatch.grid(row = 3, column = 1)#,sticky = "nsew")
        ...
        self.reset.grid(row = 3, column = 2)#, sticky = "nsew")
        ...
        goback.grid(row = 4, column = 0)#, pady = (20,0))
        gohome = tk.Button(self, bg = "black", fg = "black", bd = 0,
                           highlightbackground = "black",
                           activebackground = "black",
                           activeforeground = "black", image = icons[16],
                           text = "Home", command = self.home)
        gohome.grid(row = 4, column = 2)#, pady = (20,0))
...
class CalendarFrame(tk.Frame):
    ...
    def setup(self, y, m):
        ...
        right_year = tk.Button(self, text='∧',font=("bold", 16),
                               bd = 0, bg = "black", fg = "tomato",
...
class AudioFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        homebutton = tk.Button(self, text = "Home", image = icons[16],
                               ...
                               command = lambda:
                               controller.show_frame("HomeFrame"))
        homebutton.grid(row = 4, column = 2, sticky = "nsew")#, padx = 5)
...
class SensorFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,text = "Read ADC Values" ,font=("bold", 22)
                 , bg = "black", fg="red").grid(row = 0, column = 0,
                                                columnspan = 5)
        
        tk.Label(self,text = "Measure Voltage Range 0v - 2.1v" ,
                 font=("bold", 15), bg = "yellow").grid(row = 1, column = 0,
                                                        columnspan = 5)


        tk.Label(self,text = "ADC 0" ,font=("bold", 22), bg = "black",
                 fg="gold2").grid(row = 2, column = 0, columnspan=2)
        tk.Button(self, text="Read ADC 0\n (mV)",
                  font=("helvetica", 15),
                  command = self.read_ADC0).grid(row = 3, column = 0,
                                                 sticky='n')
        
        self.adc0 = tk.Entry(self,font=("bold", 20),width = 7)
        self.adc0.grid(row = 3, column = 1,sticky='nw')
        
        tk.Label(self,text = "ADC 1" ,font=("bold", 22), bg = "black",
                 fg="gold2").grid(row = 2, column = 3, columnspan=2)
        tk.Button(self, text="Read ADC 1\n (mV)",
                  font=("helvetica", 15),
                  command = self.read_ADC1).grid(row = 3, column = 3,
                                                 sticky='n')

        
        self.adc1 = tk.Entry(self, font=("bold", 20), width = 7)
        self.adc1.grid(row = 3, column = 4,sticky='nw')

        tk.Button(self, bg = "black", fg = "black", bd = 0,
                  highlightbackground = "black",  activebackground = "black",
                  activeforeground = "black",image = icons[30],
                  command = self.back).grid(row = 4,column = 0)
        tk.Button(self, bg = "black", fg = "black", bd = 0,
                  highlightbackground = "black",  activebackground = "black",
                  activeforeground = "black",image = icons[16],
                  command = self.home).grid(row = 4, column = 4, sticky='w')
...
class PiFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, bg = "black",text = "This feature allows you to\n "
                 "access your Raspberry Pi by shutting down the phone UI",
                 font = ("Helvetica", 20),
                 fg = "Deep sky blue").grid(row = 0, column = 0, columnspan = 3)
        
        tk.Label(self, text = "Press OK to confirm", fg = "yellow",
                 bg = "black",
                 font = ("Helvetica", 20)).grid(row = 1, column = 1)
        
        tk.Button(self, text = "OK" ,fg = "yellow",image = icons[18],
                  font = ("Helvetica", 15), anchor = "center",
                  highlightbackground = "white", bg = "black",
                  activebackground = "black",activeforeground = "white",
                  compound = "top",
                  command = self.closeUI).grid(row = 2, column = 1)

        tk.Button(self, text = "Back",image = icons[30],bd = 0,
                  highlightbackground = "black", bg = "black",
                  activebackground = "black",
                  anchor = "center", command = lambda :
                  self.controller.
                  show_frame("Menu2Frame")).grid(row = 3, column = 0)
...
class AboutFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        header_label = tk.Label(self, text = "PiTalk", fg = "gold2", bg = "black", font = ("Helvetica", 30))
        header_label.grid(row = 0, column = 2, sticky = "ew")

        tk.Label(self, text = 'PiTalk is a 3G GSM Shield for Raspberry Pi',
                 bg = "black", fg = "olive drab",
                 font = ("Bold", 20)).grid(row = 2, column = 0, columnspan = 5,
                                           sticky = "w")
        ...
        tk.Label(self, text = "  ->Compatiable with Pi2/Pi3/PiZero",
                 bg = "black", fg = "white",
                 font = ("Helvetica",18)).grid(row = 6, column = 0,
                                               sticky = "w", columnspan = 5)
        tk.Label(self, text = "For More Info:", bg = "black",
                 fg = "turquoise",
                 font = ("Bold",20)).grid(row = 7, column = 0, sticky = "w",
                                          columnspan = 5)
        tk.Label(self, text = '    www.sb-components.co.uk', bg = "black",
                 fg = "white",
                 font = ("Helvetica",18)).grid(row = 8, column = 0,
                                               sticky = "w", columnspan = 5)
        tk.Label(self, text = "Developed by:", bg = "black", fg = "tomato",
                 font = ("Bold",20)).grid(row = 9, column = 0, sticky = "w",
                                          columnspan = 5)
        tk.Label(self, text = "  Ankur Singh ", bg = "black", fg = "white",
                 font = ("Helvetica",18)).grid(row = 10, column = 0,
                                               sticky = "w", columnspan = 5)
        tk.Label(self, text = "  Asher Ahmad Farooqui", bg = "black",
                 fg = "white", font = ("Helvetica",18)).grid(row = 11,
                                                             column = 0,
                                                             sticky = "w",
                                                             columnspan = 5)
...
class SIMFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text = "IMEI Number:",font = ("bold", 28), bg = "black",
                 fg = "orange red").pack()
        ...
        tk.Label(self, text = "Module: ",font = ("bold", 28),bg = "black",
                 fg = "orange red").pack()
        ...
        tk.Button(self, text="Read",font = ("Helvetica", 18),bg = "black",
                  fg = "green", bd=4,command=self.read).pack(pady = (20,0))
...
class SettingsFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Button(self, text = "Go Home", image = icons[16], fg = "white",
                  bd = 0, anchor = "center",command = lambda:
...
class GUIRotateFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text ="** This will reboot your system and calibrate "
                 "the screen **", font = ("Helvetica", 18),
                 bd = 2,fg = "tomato",
                 bg = "black").grid(row = 0, column = 0,columnspan = 2 )

        tk.Button(self, text = "Rotate 0°  ",image  = icons[39],
        ...
        tk.Button(self, text = "Rotate 90° ", image  = icons[40],
                  command = lambda:self.screenRotate(90),bg = "black",
                  fg = "white",font = ("helvetica", 15),bd = 2,
                  highlightbackground = "black",compound="left",
                  activebackground = "black",
                  activeforeground = "white").grid(row = 1, column = 1)

        tk.Button(self, text = "Rotate 180°",image  = icons[41],
                  command = lambda:self.screenRotate(180), bg = "black",
                  fg = "white", font = ("helvetica", 15),bd = 2,
                  highlightbackground = "black",compound="left",
                  activebackground = "black",
                  activeforeground = "white").grid(row = 2, column = 0)

        tk.Button(self, text = "Rotate 270°",image  = icons[42],
                  command = lambda:self.screenRotate(270), bg = "black",
                  fg = "white",font = ("helvetica", 15),bd = 2,
                  highlightbackground = "black",compound="left",
                  activebackground = "black",
                  activeforeground = "white").grid(row = 2, column = 1)

        tk.Button(self, text = "go Back",image = icons[30], bg = "black",
                  fg = "black", bd = 0, highlightbackground = "black",
                  activebackground = "black", activeforeground = "black",
                  command = lambda:
                  controller.show_frame("SettingsFrame")).grid(row = 4,
                                                               column = 0)

        tk.Button(self, text = "Go Home", image = icons[16], bg = "black",
                  fg = "white", bd = 0, highlightbackground = "black",
                  activebackground = "black", activeforeground = "black",
                  command = lambda:
                  controller.show_frame("HomeFrame")).grid(row = 4, column = 1)
...
class CallSettingFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Canvas(self, bg = "snow", height = 10).grid(row = 0, column = 0,
                                                       columnspan = 6 ,
                                                       sticky = "nsew")
        ...
        self.ringspin = tk.Spinbox(self,from_=0, to = 255, width = 10,
                                   font = ("Helvetica", 15))
        self.ringspin.grid(row = 0, column = 1, columnspan = 2, sticky = "w")

        tk.Button(self,text = "Set",bg = "deep sky blue", fg = "white",
                  command = self.ring_Set,
                  font = ("Helvetica", 16)).grid(row = 0, column = 4,
                                                 columnspan = 2, pady = 2)
        tk.Button(self,text = "Check Call Forwading", bg = "black",
                  fg = "white",  font = ("Helvetica", 16),
                  command = self.check_status).grid(row = 3, column = 4,
                                                    columnspan = 2,
                                                    sticky = "ew")
        tk.Button(self,text = "Disable Call Forwading", bg = "black",
                  fg = "white",font = ("Helvetica", 16),
                  command = self.disable_callforwarding).grid(row = 4,
                                                              column = 4,
                                                              columnspan = 2,
                                                              sticky = "ew")
        ...
        self.forwardnumber = tk.Entry(self, font = ('bold', 18),justify="right",
                                      fg='RoyalBlue1')
        self.forwardnumber.grid(row = 2, column = 1, columnspan = 3,
                                sticky = "ew")
        ...
        tk.Button(self,image = icons[30], bg = "black", fg = "black", bd = 0,
                  ...
                  activeforeground = "black",
                  command = lambda:
                  controller.show_frame("SettingsFrame")).grid(row = 6,
                                                               column = 0)
...
class HDMIFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, bg = "black", fg = "Deep sky blue",
                 text = "Selecting this reboots and changes output to HDMI",
        ...
        tk.Button(self, text = "OK" ,fg = "yellow",image = icons[43],
                  font = ("Helvetica", 15), anchor = "center",
                  highlightbackground = "white", bg = "black",
                  activebackground = "black",activeforeground = "white",
                  compound = "top",
                  command = self.hdmi_mode).grid(row = 2, column = 1)
        ...
        tk.Button(self, text = "Back",image = icons[30],bd = 0,
                  ...
                  command = lambda :
                  self.controller.
                  show_frame("SettingsFrame")).grid(row = 3, column = 0)
        
        tk.Button(self, text = "Go Home", image = icons[16], anchor = "center",bd = 0,highlightbackground = "black", bg = "black", activebackground = "black",
...
class LogFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Button(self, text = "  Delete All Logs ", image  = icons[49],
        ...
        tk.Button(self, text = "Back",image = icons[30],bd = 0,
                  ...
                  activebackground = "black",
                  anchor = "center", command = lambda :
                  self.controller.show_frame("SettingsFrame")).grid(row = 3,
                                                                    column = 0)
...
class ShutdownFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, bg = "black", fg = "Deep sky blue",
                 text = "Selecting this shuts down your GSM Module and UI",
                 font = ("Helvetica", 20)).grid(row = 0, column = 0,
                                                columnspan = 3)
        ...
        tk.Button(self, text = "OK" ,fg = "yellow",image = icons[44],
                  font = ("Helvetica", 15), anchor = "center",
                  highlightbackground = "white", bg = "black",
                  activebackground = "black",activeforeground = "white",
                  compound = "top", command = self.shutdown).grid(row = 2,
                                                                  column = 1)
...
class LocationFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.lattitude = tk.Label(self, text = "Lattitude: " , bg = "black",
                                  ...
                                  activebackground = "black",
                                  activeforeground = "white",)
        self.lattitude.grid(row = 1, column = 0, sticky = "nsew")
        ...
        self.longitude = tk.Label(self, text = "Longitude: ", bg = "black",
                                  ...
                                  activebackground = "black",
                                  activeforeground = "white")
        self.longitude.grid(row = 1, column = 2, sticky = "nsew")

        self.getposition = tk.Button(self, text = "  Get Position ",
                                     image  = icons[14],
                                     command = self.get_position, bg = "black", fg = "white",
                                     font = ("helvetica", 15),bd=2,
                                     highlightbackground="black",
                                     compound="left",activebackground = "black",
                                     activeforeground = "white")
        self.getposition.grid(row = 2, column = 0, columnspan = 3)
        
        tk.Button(self, text = "Back",image = icons[30],bd = 0,
                  highlightbackground = "black", bg = "black",
                  activebackground = "black",anchor = "center",
                  command = self.goback).grid(row = 3, column = 0)
        
        tk.Button(self, text = "Go Home", image = icons[16],bd = 0,
                  highlightbackground = "black", bg = "black",
                  activebackground = "black",anchor = "center",
                  command = self.gohome).grid(row = 3, column = 2)


    def get_position(self):
        """ Get coordinates """
        self.lattitude.config(text = "Lattitude: "+
                              str(phone.get_location()[0])+"°")# lattitude
        self.longitude.config(text = "Longitude: "+
                              str(phone.get_location()[1])+"°")# longitude
...
class TemplateFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading = tk.Label(self, bg = "black", fg = "Deep sky blue",
                           text = "Develop\nyour apps here",
                           font = ("Helvetica", 30))
        heading.grid(row = 0, column = 0, columnspan = 2)
        
        backButton = tk.Button(self,image = icons[30],bd = 0,
                               highlightbackground = "black", bg = "black",
                               activebackground = "black",
                               anchor = "center", command = lambda:
                               self.controller.show_frame("Menu2Frame"))
        ...
        homeButton = tk.Button(self, image = icons[16], anchor = "center",
                               bd = 0,highlightbackground = "black",
